...
export const Login = () => {
  ...
  const onSubmit = handleSubmit((data) => {
    loginFn(data.email, data.password).then(() => {
      navigate("/");
    });
  });

  return (
    <section className="gradient-form h-full bg-tech-gold">
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 drop-shadow-lg">
        <a
          href="#"
          className="flex items-center mb-10 text-3xl font-semibold text-white"
        >
          <svg
        ...
        <div className="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            >
              ...
              {/* DO NOT TOUCH FOR NOW: This is for "Forgotten Password?" */}
              {/* <div className="flex items-center justify-between">
                <a href="#" className="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500">Forgot password?</a>
              </div> */}
              <button
              ...
              <p className="text-sm font-light text-gray-500">
                ...
                <Link
                  to="../register"
                  className="font-medium text-navy-blue hover:underline"
                >
                  Sign up
                </Link>
              </p>
